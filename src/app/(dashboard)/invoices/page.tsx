...
const tabs: Array<{ label: string; value?: InvoiceStatus }> = [
              ...
              {invoices.map((inv) => (
                ...
                >
                  ...
                  <td className="px-5 py-4">
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${STATUS_STYLE[inv.status]
                        }`}
                    >
